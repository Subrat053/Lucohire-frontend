      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-6">
          <div className="max-w-xl">
            <h1 className="text-[28px] md:text-[40px] font-bold text-[#081B3A] leading-tight tracking-tight">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div className="flex flex-col sm:flex-row bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden text-sm font-semibold">
              <div className="flex-1 p-4 border-l-4 sm:border-l-0 sm:border-b-[3px] border-indigo-600 text-indigo-700 bg-indigo-50/30 flex flex-col items-start cursor-pointer">
                ...
                <div className="text-[11px] font-medium text-indigo-500 flex items-center gap-1">
                  Free Preview <span className="w-1 h-1 bg-gray-300 rounded-full mx-1"></span> No Login Required
                </div>
              </div>
              ...
              <div onClick={() => setIsModalOpen(true)} className="flex-1 p-4 border-b border-gray-200 text-gray-600 hover:bg-gray-50 flex flex-col items-start cursor-pointer transition">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span>Upload JD / Requirement</span>
                  <span className="text-[10px] bg-gray-100 text-gray-600 px-1.5 py-0.5 rounded font-bold ml-1">Login Required</span>
                </div>
                <div className="text-[11px] font-medium text-gray-500">
                  Unlock AI JD parsing & smart matching
                </div>
              </div>
              ...
              <div onClick={() => setIsModalOpen(true)} className="flex-1 p-4 border-b border-gray-200 text-gray-600 hover:bg-gray-50 flex flex-col items-start cursor-pointer transition">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span>Ask Luco AI</span>
                  <span className="text-[10px] bg-gray-100 text-gray-600 px-1.5 py-0.5 rounded font-bold ml-1">Login Required</span>
                </div>
                <div className="text-[11px] font-medium text-gray-500">
                  Get AI hiring advice & insights
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              <div className="flex items-center gap-2 mb-2">
                <h2 className="text-lg font-bold text-gray-900">1. Search Candidates</h2>
                <span className="text-sm font-medium text-gray-500">(Free Preview)</span>
              </div>
              <p className="text-sm text-gray-600 mb-5">Fill in the filters below to find the best matching candidates.</p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:flex md:flex-wrap lg:flex-nowrap gap-3 items-end opacity-80 pointer-events-none">
                <div className="w-full md:flex-1">
                  <label className="block text-xs font-semibold text-gray-700 mb-1.5">Skills / Keywords</label>
                  <div className="border border-gray-200 rounded-lg p-2 min-h-[42px] flex flex-wrap items-center gap-2 bg-white">
                    <span className="bg-gray-100 text-gray-700 text-xs px-2 py-1 rounded-md flex items-center gap-1 font-medium">React <FiX className="w-3 h-3"/></span>
                    <span className="bg-gray-100 text-gray-700 text-xs px-2 py-1 rounded-md flex items-center gap-1 font-medium">UI/UX <FiX className="w-3 h-3"/></span>
                  </div>
                </div>
                <div className="w-full sm:w-auto md:w-1/6">
                  ...
                  <div className="border border-gray-200 rounded-lg px-3 py-2.5 bg-white flex justify-between items-center">
                    <span className="text-sm font-medium text-gray-800">3 - 7 Years</span>
                ...
                <div className="w-full sm:w-auto md:w-1/6">
                  ...
                  <div className="border border-gray-200 rounded-lg px-3 py-2.5 bg-white flex justify-between items-center">
                    <span className="text-sm font-medium text-gray-800">Bangalore</span>
                  </div>
                </div>
                <div className="w-full sm:w-auto md:w-1/6">
                  <label className="block text-xs font-semibold text-gray-700 mb-1.5">Salary Range</label>
                  <div className="border border-gray-200 rounded-lg px-3 py-2.5 bg-white flex justify-between items-center">
                    <span className="text-sm font-medium text-gray-800">₹8 - ₹20 LPA</span>
                    <FiChevronDown className="text-gray-400" />
                  </div>
                </div>
              ...
              <div className="flex items-center gap-3 mt-5">
                <span className="text-xs font-bold text-gray-800">Popular searches:</span>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden">
              <div className="flex-1 w-full relative z-10">
                <h2 className="text-base font-bold text-gray-900 mb-6">2. Luco AI is searching the best matches for you...</h2>
                <div className="flex items-center justify-between relative w-full overflow-x-auto pb-4 hide-scrollbar">
                  ...
                  <div className="flex flex-col items-center gap-2 relative z-10 min-w-[80px]">
                    ...
                    <p className="text-[10px] font-bold text-indigo-600 text-center leading-tight">Best Matches Found</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-purple-50/50 rounded-xl p-4 border border-purple-100 flex flex-col items-center justify-center min-w-[240px] relative z-10">
                <h3 className="text-sm font-bold text-purple-900 flex items-center gap-1">
                  <span className="text-purple-500">✨</span> 92 Best Matches Found! <span className="text-purple-500">✨</span>
                </h3>
                <p className="text-[11px] text-purple-700 mt-1 mb-3 text-center">AI has found the most relevant candidates for your search.</p>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              <div className="flex justify-between items-center mb-6">
                <div className="flex items-center gap-2">
                  <h2 className="text-lg font-bold text-gray-900">3. Top Matching Candidates</h2>
                  <span className="text-sm font-medium text-gray-500">(Free Preview)</span>
                </div>
                <div className="flex items-center gap-4">
                  <span className="text-xs font-semibold text-gray-500 flex items-center gap-1">
                    <FiLock className="w-3 h-3" /> Sign up to unlock full profiles, contact details & more
                  </span>
                  <div className="text-xs font-bold text-gray-700 flex items-center gap-1 cursor-pointer">
                    Sort by: Best Match <FiChevronDown />
                  </div>
                </div>
              </div>
                ...
                {candidates.map((candidate) => (
                  <div key={candidate.id} className="group border border-gray-200 rounded-xl p-5 relative overflow-hidden transition-all hover:border-indigo-300 hover:shadow-md bg-white">
                    ...
                    <div className="hidden md:flex absolute inset-0 bg-white/30 backdrop-blur-[2.5px] z-10 items-center justify-end pr-8 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      ...
                      >
                        <FiLock className="w-4 h-4" /> Unlock Profile
                      </button>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row gap-6 relative">
                      ...
                      <div className="flex gap-4 w-full md:w-[45%]">
                        ...
                        <div className="flex-1">
                          <div className="text-[11px] font-extrabold text-emerald-600 mb-0.5">{candidate.match}% Match</div>
                          ...
                          <div className="flex items-center gap-3 text-[11px] font-medium text-gray-500 mt-1.5">
                            <span className="flex items-center gap-1"><FiBriefcase className="w-3 h-3"/> Experience: {candidate.experience}</span>
                      ...
                      <div className="w-full md:w-[25%] flex flex-col justify-center border-t md:border-t-0 md:border-l border-gray-100 pt-4 md:pt-0 md:pl-6">
                        <p className="text-[10px] font-bold text-gray-400 uppercase mb-1">Current Company</p>
                      ...
                      <div className="w-full md:w-[30%] flex flex-col justify-center md:items-end border-t md:border-t-0 md:border-l border-gray-100 pt-4 md:pt-0 md:pr-2 md:pl-4 relative">
                        ...
                        <div className="text-left md:text-right w-full mt-2">
                          <p className="text-[10px] font-bold text-gray-400 uppercase mb-1">Expected Salary</p>
                          <p className="font-extrabold text-gray-900 text-lg leading-none">{candidate.salary}</p>
                          <button onClick={() => setIsModalOpen(true)} className="text-[11px] font-bold text-indigo-600 mt-1 hover:underline">
                            View match details &gt;
                          </button>
                        </div>
                        <button 
              ...
              <div className="mt-6 text-center">
                <button onClick={() => setIsModalOpen(true)} className="text-indigo-600 font-bold text-sm flex items-center gap-1 mx-auto hover:bg-indigo-50 px-4 py-2 rounded-lg transition">
                  View More Matches <FiChevronDown />
                </button>
              </div>
            </div>
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="bg-indigo-50 rounded-2xl border border-indigo-100 p-5 flex items-start gap-4">
              ...
              <div>
                <h3 className="font-bold text-indigo-900 text-sm">Login to unlock all AI features</h3>
                <p className="text-[11px] font-medium text-indigo-700 mt-1">It's free and takes less than 30 seconds!</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              <h3 className="font-bold text-gray-900 text-sm flex items-center gap-2 mb-5">
                <span className="text-purple-500">✨</span> Why recruiters choose Lucohire AI
              </h3>
                  ...
                  <div key={feature.id} className="flex gap-3 items-start">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between">
                        ...
                        {feature.isNew && <span className="text-[9px] font-bold text-blue-600 bg-blue-50 px-1.5 py-0.5 rounded">New</span>}
                      </div>
              ...
              <button onClick={() => setIsModalOpen(true)} className="text-xs font-bold text-indigo-600 mt-5 flex items-center gap-1 hover:underline">
                See all 12 AI features <FiArrowRight />
              </button>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl border border-purple-100 p-6">
              <h3 className="font-bold text-gray-900 text-sm flex items-center gap-2 mb-4">
                <FiStar className="text-purple-600" fill="currentColor"/> Boost Your Job & Get Better Results
              </h3>
              <div className="grid grid-cols-3 gap-2 mb-4">
                <div className="text-center">
                  ...
                  <p className="text-[9px] font-bold text-gray-800 leading-tight">Featured Job</p>
                  <p className="text-[8px] text-gray-500">5x more visibility</p>
                </div>
                <div className="text-center">
                  ...
                  <p className="text-[9px] font-bold text-gray-800 leading-tight">Featured Company</p>
                  <p className="text-[8px] text-gray-500">Stand out brand</p>
                </div>
                <div className="text-center">
                  ...
                  <p className="text-[9px] font-bold text-gray-800 leading-tight">Urgent Hiring</p>
                  <p className="text-[8px] text-gray-500">Priority alerts</p>
                </div>
              </div>
              <button onClick={() => setIsModalOpen(true)} className="w-full bg-indigo-600 text-white font-bold py-2.5 rounded-lg text-sm hover:bg-indigo-700 transition shadow-md">
                Boost Now &rarr;
              </button>
              <p className="text-[10px] text-center font-bold text-indigo-600 mt-3 cursor-pointer hover:underline">View Boost Plans</p>
            </div>

            {/* Analytics Box */}
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              <h3 className="font-bold text-gray-900 text-sm mb-4">Job Performance Preview (AI)</h3>
              <p className="text-[11px] font-medium text-gray-500 mb-4">Get AI predictions before you post</p>
              
              <div className="flex justify-between items-center pb-4 border-b border-gray-100 mb-4">
                <div>
                  <p className="text-[10px] font-bold text-gray-400 uppercase mb-1">Expected Views</p>
                  <p className="text-xl font-extrabold text-gray-900">12,500</p>
                  <p className="text-[10px] font-bold text-emerald-500 mt-1">High</p>
                </div>
                <div className="text-right">
                  <p className="text-[10px] font-bold text-gray-400 uppercase mb-1">Expected Applications</p>
              ...
              <div className="flex justify-between items-center">
                <p className="text-sm font-bold text-gray-900">Match Quality</p>
                <div className="text-right">
                  <p className="text-lg font-extrabold text-emerald-600">92%</p>
                  <p className="text-[10px] font-bold text-emerald-500 uppercase">Excellent</p>
                </div>
              </div>

              <button onClick={() => setIsModalOpen(true)} className="text-[11px] font-bold text-indigo-600 mt-4 hover:underline">
                Check Hiring Health Score after login &rarr;
              </button>
            </div>
