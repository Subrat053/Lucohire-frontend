      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
        ...
        <div className="xl:col-span-4 space-y-6">
          ...
          <div className="bg-white rounded-3xl border border-gray-100 shadow-[0_4px_24px_-8px_rgba(0,0,0,0.05)] p-6">
            ...
            <button onClick={() => navigate('/provider/career-health')} className="w-full py-3 bg-white border border-gray-200 hover:bg-gray-50 rounded-xl text-xs font-bold text-[#1a1b41] transition-colors flex items-center justify-center gap-1">
