      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        <div>
          ...
          <p className="text-[13px] font-medium text-gray-500 mt-0.5">
            Bulk import recruiters using a structured CSV file with live batch processing.
          </p>
        </div>
      </div>
        ...
        <div className="p-6 md:p-10 flex flex-col items-center justify-center text-center space-y-6">
          ...
          <div className="max-w-md">
            ...
            <p className="text-sm text-gray-500 mb-6">
              Download our template, fill in the recruiter data, and upload it back here. The system will automatically create accounts and process them in the background.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <label className="cursor-pointer px-6 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-bold rounded-lg shadow-sm shadow-indigo-200 transition-all flex items-center gap-2 w-full sm:w-auto justify-center relative overflow-hidden">
                {loading ? (
                  <>
                    ...
                    return (
                      <tr key={batch._id} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-5 py-4">
                          <div className="flex items-center gap-3">
                            <div className="flex-1 h-2 bg-gray-100 rounded-full overflow-hidden w-32">
                              <div 
                                className={`h-full rounded-full ${batch.status === 'failed' ? 'bg-red-500' : 'bg-indigo-500'}`} 
                        ...
                        <td className="px-5 py-4 text-right space-x-2">
                          ...
                          {batch.status === 'paused' && (
                            <>
                              <button onClick={() => handleAction(batch._id, 'resume')} className="p-1.5 text-indigo-600 hover:bg-indigo-50 rounded-md border border-indigo-200 transition-colors" title="Resume">
