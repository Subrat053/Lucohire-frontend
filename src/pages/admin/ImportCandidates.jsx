      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        <div>
          ...
          <p className="text-[13px] font-medium text-gray-500 mt-0.5">
            Bulk import candidates/providers using a structured CSV file.
          </p>
        </div>
      </div>
        ...
        <div className="p-6 md:p-10 flex flex-col items-center justify-center text-center space-y-6">
          ...
          <div className="max-w-md">
            ...
            <p className="text-sm text-gray-500 mb-6">
              Download our template, fill in the candidate data, and upload it back here. The system will automatically create accounts and send onboarding emails.
            </p>
