...
const CreatePartnerProvider = () => {
  ...
  const submit = async (e) => {
    ...
    try {
      setLoading(true);
      await partnerApi.createProvider(form);
  ...
  return (
    <div className="max-w-2xl bg-white rounded-3xl border border-[#EAE7F2] p-6 shadow-sm">
      <h1 className="text-2xl font-extrabold text-gray-900">Create Provider Profile</h1>
      <p className="text-gray-500 text-sm mt-1">This provider will be linked with your referral account.</p>
