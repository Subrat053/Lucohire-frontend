...
import {
  ...
  HiChevronLeft, HiChevronRight, HiLogout, HiMenu, HiX, HiDocumentText, HiShieldExclamation, HiCreditCard, HiCollection, HiGlobe, HiUserGroup, HiLink, HiGift, HiLockClosed, HiOutlineDocumentText, HiQuestionMarkCircle, HiInformationCircle, HiClipboardList, HiDatabase, HiTerminal, HiChatAlt2, HiLockOpen
} from 'react-icons/hi';
...
const navItems = [
  ...
  { labelKey: 'admin.dataPipeline', fallback: 'Data Pipeline & Sync', path: '/admin/data-pipeline', icon: HiDatabase, adminOnly: true },
  { labelKey: 'admin.crawlers', fallback: 'Scrapers & Crawlers', path: '/admin/crawlers', icon: HiTerminal, adminOnly: true },
  { labelKey: 'admin.scrapedVault', fallback: 'Scraped Data Vault', path: '/admin/scraped-vault', icon: HiTerminal, adminOnly: true },
  ...
  { labelKey: 'admin.paymentIssues', fallback: 'Payment Issues', path: '/admin/payment-issues', icon: HiChatAlt2, adminOnly: true },
