...
<<<<<<< HEAD
          className="flex space-x-3 sm:space-x-4 overflow-x-auto pb-4 pt-2 px-1 sm:px-10 scroll-smooth [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]"
=======
...
>>>>>>> 3d3c967d06b4ab173e982db8fd282cd77a2b94b7
        >
          {isLoadingJobs ? (
            [1, 2, 3, 4, 5].map(i => (
